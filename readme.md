...
- **Design Pattern** [Design Patterns](https://en.wikipedia.org/wiki/Design_Patterns) | [javatpoint](https://www.javatpoint.com/prototype-design-pattern)
  ...
  - Behavioral
    ...
    - Command: todo [wiki]() | [code](./readme.md) | [best practices](./readme.md) 
    - *Interpreter: todo[wiki]() | [code](./readme.md) | [best practices](./readme.md) 
    - *Iterator: [wiki](https://en.wikipedia.org/wiki/Iterator_pattern) | [code](./readme.md) | [best practices](./readme.md) 
    - Mediator: todo[wiki]() | [code](./readme.md) | [best practices](./readme.md) 
    - Memento: todo[wiki]() | [code](./readme.md) | [best practices](./readme.md) 
    - Observer: todo[wiki]() | [code](./readme.md) | [best practices](./readme.md) 
    - State: todo[wiki]() | [code](./readme.md) | [best practices](./readme.md) 
    ...
    - Template method : todo[wiki]() | [code](./readme.md) | [best practices](./readme.md) 
    - Visitor: todo[wiki]() | [code](./readme.md) | [best practices](./readme.md) 
  - Composition:
