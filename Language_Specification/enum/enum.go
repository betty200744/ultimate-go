...
const (
	ACTION_TYPE_ACTION_EMPTY    ACTION_TYPE = iota
	ACTION_TYPE_ACTION_PICKUP   ACTION_TYPE
	ACTION_TYPE_ACTION_PUTDOWN  ACTION_TYPE
	ACTION_TYPE_ACTION_TOUCH    ACTION_TYPE
	ACTION_TYPE_ACTION_APPROACH ACTION_TYPE
)
